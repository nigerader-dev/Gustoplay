...
export const GENRES = {
  action:      { ru: 'Экшен',              en: 'Action',        icon: '💥' },
  shooter:     { ru: 'Шутер',              en: 'Shooter',       icon: '🔫' },
  rpg:         { ru: 'РПГ',                en: 'RPG',           icon: '🗡️' },
  mmo:         { ru: 'MMO',                en: 'MMO',           icon: '🌐' },
  strategy:    { ru: 'Стратегия',          en: 'Strategy',      icon: '♟️' },
  tactics:     { ru: 'Тактика',            en: 'Tactics',       icon: '🎯' },
  survival:    { ru: 'Выживание',          en: 'Survival',      icon: '🏕️' },
  horror:      { ru: 'Хоррор',             en: 'Horror',        icon: '👻' },
  adventure:   { ru: 'Приключение',        en: 'Adventure',     icon: '🧭' },
  puzzle:      { ru: 'Головоломка',        en: 'Puzzle',        icon: '🧩' },
  platformer:  { ru: 'Платформер',         en: 'Platformer',    icon: '🏃' },
  racing:      { ru: 'Гонки',              en: 'Racing',        icon: '🏎️' },
  sandbox:     { ru: 'Песочница',          en: 'Sandbox',       icon: '🧱' },
  roguelike:   { ru: 'Рогалик',            en: 'Roguelike',     icon: '🎲' },
  metroidvania:{ ru: 'Метроидвания',       en: 'Metroidvania',  icon: '🦇' },
  simulator:   { ru: 'Симулятор',          en: 'Simulator',     icon: '🚜' },
  building:    { ru: 'Строительство',      en: 'Building',      icon: '🏗️' },
  card:        { ru: 'Карточные',          en: 'Card game',     icon: '🃏' },
  rhythm:      { ru: 'Ритм-игра',          en: 'Rhythm',        icon: '🎵' },
  party:       { ru: 'Для вечеринки',      en: 'Party',         icon: '🎉' },
  fighting:    { ru: 'Файтинг',            en: 'Fighting',      icon: '🥊' },
  stealth:     { ru: 'Стелс',              en: 'Stealth',       icon: '🥷' },
  visual:      { ru: 'Визуальная новелла', en: 'Visual novel',  icon: '📖' },
  sports:      { ru: 'Спорт',              en: 'Sports',        icon: '⚽' },
  mystery:     { ru: 'Детектив',           en: 'Mystery',       icon: '🔍' },
  moba:        { ru: 'MOBA',               en: 'MOBA',          icon: '🛡️' },
  battle:      { ru: 'Королевская битва',  en: 'Battle royale', icon: '🪂' },
  idle:        { ru: 'Идл / прогресс',     en: 'Idle',          icon: '⏲️' },
  boardgame:   { ru: 'Настольные',         en: 'Board games',   icon: '🎲' },
};
...
export const MOODS = {
  relax:    { ru: 'Расслабиться и отдохнуть', en: 'Relax and unwind', icon: '🌿' },
  adrenaline:{ ru: 'Адреналин и экшен',      en: 'Adrenaline and action', icon: '⚡' },
  story:    { ru: 'Прожить историю',         en: 'Live a story', icon: '📚' },
  think:    { ru: 'Подумать, поломать голову', en: 'Think it through', icon: '🧠' },
  laugh:    { ru: 'Посмеяться с друзьями',   en: 'Laugh with friends', icon: '😂' },
  compete:  { ru: 'Победить живых игроков',  en: 'Beat real players', icon: '🏆' },
  create:   { ru: 'Строить и творить',       en: 'Build and create', icon: '🎨' },
  scare:    { ru: 'Пощекотать нервы',        en: 'Get spooked', icon: '😱' },
  escape:   { ru: 'Сбежать от реальности',   en: 'Escape reality', icon: '🌀' },
  progress: { ru: 'Прогресс и цифры',        en: 'Progress and numbers', icon: '📈' },
  explore:  { ru: 'Исследовать новый мир',   en: 'Explore a new world', icon: '🗺️' },
  collect:  { ru: 'Собирать и коллекционировать', en: 'Collect everything', icon: '🧲' },
  tense:    { ru: 'Напряжение и саспенс',    en: 'Tension and suspense', icon: '😬' },
  learn:    { ru: 'Узнать что-то новое',     en: 'Learn something new', icon: '🎓' },
  feel:     { ru: 'Прожить сильные эмоции',  en: 'Feel something deeply', icon: '💔' },
  nostalgia:{ ru: 'Вернуться в знакомое',    en: 'Revisit the familiar', icon: '📼' },
};

export const PLATFORMS = {
  pc:     { ru: 'ПК (Steam/Epic)', en: 'PC (Steam/Epic)', icon: '🖥️' },
  ps:     { ru: 'PlayStation 5',   en: 'PlayStation 5',   icon: '🎮' },
  xbox:   { ru: 'Xbox',            en: 'Xbox',            icon: '🕹️' },
  switch: { ru: 'Nintendo Switch', en: 'Nintendo Switch', icon: '🔴' },
  mobile: { ru: 'Телефон',         en: 'Mobile',          icon: '📱' },
  cloud:  { ru: 'Облако (GeForce NOW)', en: 'Cloud gaming', icon: '☁️' },
};

/** Режимы игры: сколько человек и как — ядро фильтра «во что играть с друзьями» */
export const MODES = {
  solo:        { ru: 'Одиночная кампания', en: 'Single-player campaign', icon: '🧍' },
  coopLocal:   { ru: 'Кооп за одним экраном', en: 'Local co-op', icon: '🛋️' },
  coopOnline:  { ru: 'Кооп по сети',       en: 'Online co-op',    icon: '🌍' },
  pvpLocal:    { ru: 'PvP за одним экраном', en: 'Local PvP',     icon: '⚔️' },
  pvpOnline:   { ru: 'PvP по сети',        en: 'Online PvP',      icon: '🏅' },
  mmo:         { ru: 'Постоянный онлайн-мир', en: 'MMO world',    icon: '🌐' },
  async:       { ru: 'Асинхронный мультиплеер', en: 'Async multiplayer', icon: '✉️' },
};
