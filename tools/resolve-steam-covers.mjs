...
// 3) запись: сортировка по slug, чтобы диффы были стабильными
const lines = Object.entries(result).sort(([a], [b]) => a.localeCompare(b))
